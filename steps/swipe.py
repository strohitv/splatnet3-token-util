...
class Swipe:
	...
	def execute(self, args):
		...
		subprocess.run(f'{self.app_config.emulator_config.adb_path} shell input swipe {parsed_args.x1} {parsed_args.y1} {parsed_args.x2} {parsed_args.y2} {parsed_args.duration}',
					   shell=True,
